...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row activity text-center">
            <div class="col-md act">
                ...
                <br>
                <a href="createuser.php"><button style="background-color: green;">Create User</button></a>
            </div>

            <div class="col-md act">
                <img src="img/transfer.png" alt="transferimg" class="img-fluid">
                <br>
                <a href="transfermoney.php"><button style="background-color: red;">Make a Transaction</button></a>
            </div>

            <div class="col-md act">
                <img src="img/hist.jpg" alt="historyimg" class="img-fluid">
                <br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Created by <b>Ankit Mathur</b><br>GRIP Basic Banking</p>
    </footer>
